...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_service__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json).then(data => {
        console.log(data);
...
function modal(triggerSelecttor, modalSelector, modalTimerId) {
  // Modal
  const modal = document.querySelector(modalSelector),
        openModalBtns = document.querySelectorAll(triggerSelecttor);
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022-04-30');
